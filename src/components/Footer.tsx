    ...
    <footer className="bg-gray-900 pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4 text-red-500">ElRubiusWTF</h3>
            <p className="text-gray-400 mb-6">
              Sitio oficial de Rubén Doblas Gundersen, mejor conocido como ElRubius, uno de los creadores de contenido más influyentes del mundo hispanohablante.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-red-500 transition-colors">Términos y Condiciones</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li className="flex items-start">
                ...
                <span>contacto@elrubiuswtf.com</span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span>Solo para consultas de negocios</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} ElRubiusWTF. Todos los derechos reservados.
          </p>
